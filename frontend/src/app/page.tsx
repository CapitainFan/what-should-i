...
export default function HomePage() {
  ...
  const handleBeginChat = () => {
    window.location.href = isAuthenticated ? '/chats/new' : '/auth';
  };
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left mb-10 lg:mb-0">
        ...
        <div className="max-w-xl lg:max-w-lg xl:max-w-2xl bg-gray-100 rounded-3xl lg:rounded-4xl p-4 sm:p-6 mb-8 lg:mb-10">
          <p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed">
            Приветствуем в <strong className="font-semibold">What Should I</strong> — платформа с ИИ-помощником{' '}
            <strong className="font-semibold">Ви</strong> для принятия решений. Неважно, планируете ли вы вечер,
            ищете новое хобби или решаете что приготовить — начните диалог, и <strong className="font-semibold">Ви</strong>{' '}
            поможет выбрать лучший вариант.
          </p>
        </div>

        <Button
          className="bg-blue-500 text-white rounded-3xl px-8 py-3 sm:px-20 sm:py-8 sm:text-lg font-bold hover:bg-blue-600 active:bg-blue-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
